...
const navigation = {
  solutions: [
    ...
    { name: 'Property Management', href: '/solutions/properties' },
    { name: 'Job Portal', href: '/solutions/jobs' },
    { name: 'Staffing Solutions', href: '/solutions/maids' },
  ],
  support: [
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-white">Siscora</span>
            </div>
            <p className="text-gray-300 text-base">
              Empowering businesses with innovative technology solutions and digital transformation services.
            </p>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Siscora Technologies. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
